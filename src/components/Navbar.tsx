...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black text-white shadow-lg fixed top-0 w-full z-50"> {/* Added fixed, top-0, w-full, z-50 */}
        ...
        {isOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link
                to="/"
                className="block px-3 py-2 rounded-md text-white hover:text-gray-300 hover:bg-gray-900"
